...
public class aDespEditarReceita extends Activity {
	// inicia o repositorio
	RepositorioReceita repositorio;
	TabelaReceita tabela;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        // seta o titulo
        titBarra.setText(getString(R.string.txtMenuPri02) + "  -  " + nomeMesAno);
    ...
    public void gravarDados() {
		...
		if (gravar == 1) {
            ...
            if (count > -1) {
                Toast.makeText(aDespEditarReceita.this, "Dados atualizados com sucesso!!!", Toast.LENGTH_LONG).show();
            }
            else {
